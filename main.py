...
print(total_m)
print("Los caminos son la ruta que deberian reducir debido a que en ningun lugar resaltan tanto como en veces que fueron solicitados, ganancias por uso ni total ganado")
